...
// ALWAYSSS IMP HOW TO KNOW LOCO JS LLAGAA YA NHI : HMKO SCRLLONG PER SIDE MAI PATLI SI SIDE BAAR IN BLACK COLOR DEKHEGI AGR LAG GYA THO
function loco(){
...
// ab ho kya rhaa hai ki jaise hi hm scroll karte hai video chalne lagti hai neeche verna home per still rahegiii
gsap.to("#page>video",{
    scrollTrigger:{
        trigger:`#page>video`,
        // hlka sa 3% scrooll per video chale
        start:`2% top`,
        end:`bottom top`,
        scroller:`#main`
    },
    // hmne ye feder function use kiya jaise hi arrow touch tho video start
    onStart:()=>{
        document.querySelector("#page>video").play()
    }
})

// ye dono gsp ke function video acche se chala rahe hai 
gsap.to("#page",{
    scrollTrigger:{
        trigger:`#page`,
        start:`top top`,
...
// jo vission pro likha usko scroll karne per opacity kam ho jyagii vison ki
gsap.to("#page-bottom",{
    scrollTrigger:{
        trigger:`#page-bottom`,
        start:`5% top`,
...
// TIMELINE SE JO HEADING HAI NA JO VIDEO KE UPPER VO scroll hogi video vahi per rahegi  : 
// TIMELINE is the gsap property jisme khali ek baar trigger start do fir sari property ek hi marker se de sakte hai jaise page1 and page2
...
// trigger canvas se scroll karenge tho canvas image ladki ke upper se page scroll ho jayenge isliye csss mai page7>canvas per z index jyada badayaa
// zindex se kya hogaa ke immmages canvas ke side se nikal jayegii
trigger: `canvas`,
pin: true,
// markers:true,
scroller: `#main`,
...
// YE WALI VO JO GLASSES WALI HAI 
...
// generally hogaa kyaa jo EYES jiasaa dikh raha uske scrolling ke time aakhe bright hogi coolor change
...
// jaise hi scroll karaa aakhe chamke gi 
tl3.to("#page21>#troff",{
 opacity:0
})
...
/* jab scroll karenge thi js ka code chalegaa or opasity o se 1 hogi and glow fadding effect dekhegaa */
